...
static const ElementInfoStatistic c_TxnGen_stats[] = {
  ...
  {"writeTxnsLatency", "Average latency of write transactions", "cycles", 1},
  {"txnsLatency", "Average latency of (read/write) transactions", "cycles", 1},
  {"cycles", "total execution cycles","cycles",1},
  {NULL, NULL, NULL, 0}
};
...
static const ElementInfoPort c_Cache_ports[] = {
		...
		{ "contentLink", "link from CPU for receiving memory contents", c_MemhBridgeContent_Content_events},
		{ "lane_%(lanes)d", "link to/from lanes", c_MemhBridgeContent_Content_events},
		{ NULL, NULL, NULL } };
...
static const ElementInfoPort c_ControllerPCA_ports[] = {
		...
		{"memLink", "link to memory", c_Controller_DeviceRes_port_events},
		{ "contentLink", "link from CPU for receiving memory contents", c_MemhBridgeContent_Content_events},
		{ "lane_%(lanes)d", "link to/from lanes", c_Controller_TxnGenReq_port_events},
		{NULL, NULL, NULL}
};
...
static const ElementInfoStatistic c_ControllerPCA_stats[] = {
    ...
    {"rowsize75_cnt","","",1},
     {"rowsize100_cnt","","",1},
	   ...
	   {"predicted_success_below50","","",1},
	   {"predicted_fail_below50","","",1},
	   {"predicted_success_above50","","",1},
	   {"predicted_fail_above50","","",1},
	   {"totalQueueingDelay","","",1},
	   {"cmdQueueingDelay","","",1},
	   {"txnQueueingDelay","","",1},
...
static const ElementInfoStatistic c_Dimm_stats[] = {
  ...
  {"totalRowHits", "Number of total row hits", "hits", 1},
   {"actCmdsMetaRecvd", "Number of activate commands received", "activates", 1}, // Name, Desc, Units, Enable Level
  {"readCmdsMetaRecvd", "Number of read commands received", "reads", 1},
  {"writeCmdsMetaRecvd", "Number of write commands received", "writes", 1},
  {"preCmdsMetaRecvd", "Number of precharge commands received", "precharges", 1},
  ...
  {"actprePower", "Number of row hits at bank x", "commands", 5},
  {"readPower", "Number of row hits at bank x", "commands", 5},
  {"writePower", "Number of row hits at bank x", "commands", 5},
  {"refPower", "Number of row hits at bank x", "commands", 5},
  {"totalPower", "Number of row hits at bank x", "commands", 5},
  {"totalEnergy", "Number of row hits at bank x", "commands", 5},
  {NULL, NULL, NULL, 0}
};
